...
主な機能は、予定を知らせる通知と、システムトレイから開く予定一覧の表示です。
...
予定一覧の各項目には、開始までの残り時間を「（n時間n分後）」形式で表示します。開始が迫った予定は赤文字、次の予定は太字で強調します。フッタークリックで Google カレンダーの当日ページを開けます。予定項目の右クリックで、その予定を通知から除外できます。
